...
# 2 levels up from docs/: sale_discount_demo_access -> addons_config_defaults.
# Every automodule directive below refers to the package as
# `sale_discount_demo_access.models.xxx`, matching how the rest of this addon's own code
# imports it, so `sale_discount_demo_access` itself has to resolve as a top-level import here.
sys.path.insert(0, os.path.abspath('../..'))

project = 'sale_discount_demo_access'
