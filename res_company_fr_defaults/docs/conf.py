...
# 2 levels up from docs/: res_company_fr_defaults -> addons_config_defaults.
# Every automodule directive below refers to the package as
# `res_company_fr_defaults.models.xxx`, matching how the rest of this addon's own code
# imports it, so `res_company_fr_defaults` itself has to resolve as a top-level import here.
sys.path.insert(0, os.path.abspath('../..'))

project = 'res_company_fr_defaults'
